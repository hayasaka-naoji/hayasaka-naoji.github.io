...
(function () {
  var I18N = {
    zh: {
      ...
      'col.design.name': '设计灵感',
      'col.design.desc': '视觉、配色与灵感碎片',
      'tagline': '生活与学习的琐事',
      'intro': '这里是我的自留地：写点日记，偶尔杂谈，记录开发时的折腾，也存下设计上的灵感。不追热点，不赶节奏，只是安静地写。',
      'stat.posts': '篇文章',
      'stat.tags': '个标签',
      'stat.categories': '个专栏',
      ...
      'related.posts': '篇相关文章',
      'about.p1': '你好，我是早坂直治。',
      'about.p2': '这里是我的一块自留地。平日写点日记，记录生活的琐碎；有时也发发杂谈，说说漫无边际的想法；开发相关的折腾、设计上的灵感，则各自收在一个栏目里。',
    ...
    en: {
      ...
      'col.design.name': 'Design',
      'col.design.desc': 'Visuals, color and sparks of inspiration',
      'tagline': 'Life and learning, in passing',
      'intro': 'This is my corner of the internet: a diary here, the occasional essay there, notes on building things, and sparks of design in between. No hot takes, no rush — just quiet writing.',
      'stat.posts': 'posts',
      'stat.tags': 'tags',
      ...
      'about.p2': 'This is my own little corner. I keep a diary of everyday life, occasionally jot down wandering thoughts, and file the tinkering I do with code — and the sparks of design — in columns of their own.',
    ...
    ja: {
      ...
      'col.design.name': 'デザイン',
      'col.design.desc': 'ビジュアル・配色・インスピレーションの記録',
      'tagline': '生活と学びの些事',
      'intro': 'ここは私の居場所です。日記を書いたり、ときどき雑談をしたり、開発の試行錯誤やデザインのひらめきを記録したり。流行を追わず、急がず、ただ静かに書いています。',
      'stat.posts': '件の記事',
      'stat.tags': '個のタグ',
      ...
      'about.p2': 'ここは私の居場所です。日常の些細なことを日記に綴り、ときどきとりとめのない考えを雑談に書きます。コードまわりの試行錯誤やデザインのひらめきは、それぞれ独立したコーナーにまとめています。',
